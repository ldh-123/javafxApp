...
public class BallGame extends Application {
	private static String VIEW_GAME = "/games/GameView.fxml";
	private static String STYLESHEET_FILE = "/games/style.css";
	public static Image ICON = new Image(BallGame.class.getResourceAsStream("/games/head.png"));
