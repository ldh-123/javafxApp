 ...
 * @author Jasper Potts
 */
public class CachedTimelineTransition2 extends Transition {
    protected static final Interpolator WEB_EASE = Interpolator.SPLINE(0.25, 0.1, 0.25, 1);
    protected final Stage node;
     ...
     */
    public CachedTimelineTransition2(final Stage node, final Timeline timeline) {
     ...
     */
    public CachedTimelineTransition2(final Stage node, final Timeline timeline, final boolean useCache) {
        this.node = node;
