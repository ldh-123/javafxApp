 ...
 * <p>
 * {@literal @}keyframes flip { 0% { transform: perspective(400px) rotateY(0);
 * animation-timing-function: ease-out; } 40% { transform: perspective(400px) translateZ(150px)
 * rotateY(170deg); animation-timing-function: ease-out; } 50% { transform: perspective(400px)
 * translateZ(150px) rotateY(190deg) scale(1); animation-timing-function: ease-in; } 80% {
